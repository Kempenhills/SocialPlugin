...
#define FB_APP_DISPLAY_NAME     @"Kempenhills Social Plugin"
#define FB_APP_CAPTION          @"Kempenhills SocialPlugin on GITHub"
#define FB_APP_DESCRIPTION      @"The KHSocialPlugin makes your life allot easier when it comes to posting stuff to either Facebook or Twitter from a Cordova app!"
